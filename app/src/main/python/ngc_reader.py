...
def grade_to_string(grade, designation_code="00"):
    # A non-zero designation code does not necessarily mean Details. NGC uses
    # this field for modifiers/designations too (for example 64+). The barcode
    # provides the base lookup grade; the cert page supplies the full grade.
